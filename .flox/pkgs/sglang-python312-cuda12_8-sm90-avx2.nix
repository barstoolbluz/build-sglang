# SGLang 0.5.9 for NVIDIA Hopper (SM90: H100, H200) — AVX2
# CUDA 12.8 — Requires NVIDIA driver 550+
# Custom PyTorch built from source (SM90 + AVX2)
{ pkgs ? import <nixpkgs> {} }:
let
  ...
  smCapability = "9.0";
  variantName = "sglang-python312-cuda12_8-sm90-avx2";
...
in
  sglang.overrideAttrs (oldAttrs: {
    ...
    meta = oldAttrs.meta // {
      description = "SGLang 0.5.9 for NVIDIA H100/H200 (SM90) [CUDA 12.8, custom PyTorch AVX2]";
      platforms = [ platform ];
    };
  })
